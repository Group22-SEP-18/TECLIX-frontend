...
describe('should render correctly', () => {
	...
	it('renders correctly when required props have passed', () => {
		...
		expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
      "<div class=\\"chakra-stack css-1ye3pok\\" id=\\"leaderboard_first_3_div\\"><svg stroke=\\"currentColor\\" fill=\\"currentColor\\" stroke-width=\\"0\\" viewBox=\\"0 0 640 512\\" color=\\"gold\\" style=\\"color: gold;\\" height=\\"1em\\" width=\\"1em\\" xmlns=\\"http://www.w3.org/2000/svg\\">
...
describe('should render the correct values which have been passed', () => {
	it('should have correct salesperson name', () => {
		...
		expect(
			container.querySelector('#leaderboard_first_3_sp_name').textContent
	...
	it('should have points for today if no timeConstraint is there', () => {
		...
		expect(
			container.querySelector('#leaderboard_first_3_sp_points').textContent
	...
	it('should render a avatar', () => {
		...
		expect(
			container.querySelector('#leaderboard_first_3_sp_profile_picture')
		).toBeInTheDocument();
	});
});
